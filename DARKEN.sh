...
install() {
echo -e "\033[0;36m"
echo -e "~ Welcome To Source DARKEN - اهلا بك في سورس داركن ~"
...
wget "apiRDO.ml/installubuntu18/compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb" && sudo dpkg -i compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb
...
echo -e "|-------------------------------------------|"
echo -e "|This Source Was Developed By (RDO) @GD_400.|"
echo -e "|  This Is The Source Channel @x_pxxp .   |"
echo -e "|               - DARKEN -                 |"
echo -e "---------------------------------------------"
echo -e "\033[0m"
